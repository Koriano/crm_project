                ...
                <form method="post" action="${form_link}">
                    <fieldset>
                        ...
                        <div class="form row justify-content-center pb-5">
                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modifyEntity">Mettre à jour</button>
                        </div>


                        <!-- Modal -->
                        <div class="modal fade" id="modifyEntity" tabindex="-1" role="dialog" aria-labelledby="modifyEntityLabel" aria-hidden="true">
